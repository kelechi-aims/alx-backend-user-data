...
class DB:
    ...
    def find_user_by(self, **kwargs) -> User:
        ...
        Retrns:
            User: User object representing the first user found

        Raises:
            NoResultFound: When no users match the specified criteria
    ...
    def update_user(self, user_id: int, **kwargs) -> None:
        """Update a user in the database by the specified user_id
        ...
        Raises:
            ValueError: When an argument doest not correspond
            to a user attribute
        """
